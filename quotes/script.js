var quotes = `{"quotes":[
        {"author":"Karel Čapek",      "src":"Krakatit",                             "content":"Člověk nemá být šťastný; to ho změkčuje, víte? Pak se mu zdá všechno ostátní zbytečné, malé... a nesmyslné. Nejvíc... nejvíc udělá člověk ze zoufalství. Ze stesku, ze samoty, z ohlušování. Protože mu nic nestačí. Já jsem pracoval jako blázen. Ale tady, tady jsem začal být šťastný. Tady jsem poznal, že je snad... něco lepšího než myslet"},
        {"author":"Leonardo Da'Vinci","src":"",                                     "content":"Simplicity is the ultimate sohpistication"},
        {"author":"Karel Čapek",      "src":"Továrna na absolutno, 213",            "content":"Neboť jediné jest horší než bolest ponížení: muka nenávistí. Vidíš, zrovna tak to je, když sebou mladý člověk hází, všechno se s ním splačí. A ono není potřeba dělat velké kousky. Seď a dávej pozor na cestu, taky dojedeš"},
        ...
        {"author":"George Orwell",    "src":"Down and under in Paris & London, 21", "content":"You discover boedom and mean complications and the beginning of hunber, but you also discover the great redeeming property of poverty: that it anhihilates the..."},
        ...
        {"author":"Michael Ende",     "src":"Momo, 79",                             "content":"„To jediné,“ pokračoval muž jako stroj, „na čem v životě záleží, je, aby to člověk někam přivedl, aby se něčím stal a aby něco měl. Kddo to přivede dal než ti druzí, kdo je něčím víc a kdo má víc peněz než oni, tomu spadne všechno ostatní samo do klína.“"},
        ...
        {"author":"Michael Ende",     "src":"Momo, 129",                            "content":"Vždyť [hodiny] jsou jen velmi nedokonalé napodobeniny něčeho, co má každý člověk ukryto v hrudi. Nebo%t tak jako mají lidé oči, aby viděli světlo, a uši, aby slyšeli zvuky, tak mají také srdce, aby vnímalo čas. A všechen čas, který neproživá srdce, je stejně ztracený jako pro slepec barvy duchy, nebo jako pro hluchého ptačí píseň. Jen škoda, že jsou mezi lidmi slepá a hluchá srdce, která tlučou, a přece nic nevnímají."},
        ...
        {"author":"Anthony Stevens",  "src":"",                                     "content": "Tam, kde končí logika, ckončí věda, ale nikoli příroda. Ta prosperuje i na půdě dosud nezdupané teoriemi"},
        ...
        {"author":"Paulo Coelho",     "src":"El alquimista, 35",                    "content": "Lidé si navymýšlejí – pomyslel si pastýř. Někdy je lepší být s ovcemi, ty aspoň nic neříkají a starají se jen o potravu a voud. Anebo ještě lepší jsou knížky, ve kterých se vyprávějí neuvěřitelné příběhy, ale jen když o to člověk stojí. Když ale mluvíme s lidmi, navykládají nám někdy věcí, že nevíme, co na to říct."},
        ...
        {"author":"Klára Mayerová",   "src":"A pak ho spolknul eskalátor... 150",   "content": "„Já jím chybím,“ uvědomil si Damián. „Mají mě rádi, chybím jim všem takový, jaký jsem! Očividně je to jenom můj vlastní blbý problém, že se musím furt s někým srovnávat!“"},
        ...
        {"author":"Ray Bradbury",     "src":"Fahrenheit 451, 157",                  "content": "Rozdíl mezi člověkem, který jenom seče trávníky, a zahradníkem je ve stopě kterou po sobě zanechají. Sekáč trávy jako by tam nikdy nebyl, zahradník zůstane celý věk."},
        ...
        {"author":"Martin Wood",      "src":"Stargate 14",                          "content": "You are all but primitive. What you do not know in your head you fill with your heart."},
